...
class lindsay_koinaka_html_compression {
	// Settings
	...
	protected function minifyHTML($html) {
		...
		foreach ($matches as $token) {
			...
			if (is_null($tag)) {
				...
				else if ($content == '<!--no-html-compression-->') {
...
function lindsay_koinaka_html_compression_finish($html) {
	return new lindsay_koinaka_html_compression($html);
}

	ob_start('lindsay_koinaka_html_compression_finish');
?>
